    ...
    questions: [
      ...
      },
      {
        ...
        subquestions: [
          ...
          { id: "q3d", label: "(d)", marks: 1, type: "short-text", prompt: "The value of the note marked X in bar 3 is [answer] beat(s).", inlineAnswer: { before: "The value of the note marked X in bar 3 is", after: "beat(s)." }, acceptedAnswers: ["1.5", "1 1/2", "1½", "1 and a half", "one and a half"], answerDisplay: "1.5 or 1½" },
