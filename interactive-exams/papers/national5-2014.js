    ...
    questions: [
      ...
      },
      {
        ...
        subquestions: [
          ...
          { id: "q6c", label: "", marks: 1, type: "short-text", prompt: "The Italian term to describe the string technique used in the accompaniment is [answer].", boldPhrases: ["accompaniment"], inlineAnswer: { before: "The Italian term to describe the string technique used in the accompaniment is", after: "." }, acceptedAnswers: ["pizzicato", "pizz", "pizzacato", "pizzicatto", "pizzacatto", "pizzicatoe", "pitsicato", "pitzicato", "pitsickato"], answerDisplay: "pizzicato (pizz.)", explanation: "The accompaniment strings are plucked." },
        ],
      },
      {
