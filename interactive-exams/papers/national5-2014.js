  ...
  const paper = {
    ...
    questions: [
      ...
      },
      {
        ...
        subquestions: [
          { id: "q3a", label: "(a)", marks: 1, type: "notation-choice", notationTool: "time-signature", prompt: "Insert the time signature at the beginning of the music.", options: [option("2/4"), option("3/4"), option("4/4"), option("6/8")], answer: "4/4", answerDisplay: "4/4 or common time", explanation: "The music has four crotchet beats in each bar.", practiceLinks: [practice("timesig.html", "Practise time signatures")] },
          { id: "q3b", label: "(b)", marks: 1, type: "notation-choice", notationTool: "dynamic", prompt: "Place the quiet dynamic under the first note of bar 1.", options: [option("p", "p"), option("mp", "mp"), option("mf", "mf"), option("f", "f")], answer: "p", answerDisplay: "p (piano)", explanation: "Piano is the Italian term meaning quiet.", practiceLinks: [practice("dynamics.html", "Practise dynamics")] },
          { id: "q3c", label: "(c)", marks: 1, type: "notation-choice", notationTool: "note-entry", prompt: "Complete the three missing crotchet beats in bar 3.", options: [option("B"), option("D"), option("E"), option("F♯")], noteSlots: 3, answer: "B,D,E", answerDisplay: "B crotchet, D crotchet, E crotchet, followed by the printed F♯ quaver, E semiquaver and F♯ semiquaver", explanation: "Both the pitch and rhythm of the complete bar must be correct.", practiceLinks: [practice("missingnotes.html", "Practise melodic dictation")] },
          { id: "q3d", label: "(d)", marks: 1, type: "notation-choice", notationTool: "repeat-sign", prompt: "Insert the repeat sign at the appropriate place.", options: [option("end-bar-4", "End of bar 4"), option("end-bar-8", "End of bar 8"), option("start-bar-1", "Start of bar 1")], answer: "end-bar-8", answerDisplay: "A right repeat sign at the end of bar 8", explanation: "The repeat sign belongs at the end of bar 8.", practiceLinks: [practice("repeatsigns.html", "Practise repeat signs")] },
