...
assert.match(worksheetGeneratorSource, /editorState\?\.gridlines \?\? false/, "Intervals worksheets should leave Gridlines off by default");
...
assert.match(generic, /editorState\?\.gridlines\?\?false/, "Generic worksheets should leave Gridlines off by default");
...
assert.match(generic, /showPupilFields=!answers&&\(level!=="AH"\|\|pageNumber===1\)/, "Advanced Higher Practice Questions must show pupil fields only on page one");
