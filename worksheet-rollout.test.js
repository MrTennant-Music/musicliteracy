...
assert.match(intervalWorksheet, /page\.drawText\(heading, \{ x: 102, y: 802, size: 18/, "Intervals PDF titles must use the matching raised position");
assert.match(intervalWorksheet, /page\.drawText\(line, \{ x: 102, y: 783 - index/, "Intervals PDF instructions must use the matching raised position");
