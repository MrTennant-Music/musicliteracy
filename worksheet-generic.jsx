...
(() => {
  ...
  function Question({ question, number, example=false, answers=false, numbers=true, marks=true, firstPage=false, continuationPage=false }) {
    ...
    const answerIsInNotation = CONFIG.activityId === "barlines" || CONFIG.activityId === "timesig" || CONFIG.activityId === "triplets" || CONFIG.activityId === "rests" || CONFIG.activityId === "enharmonics" || CONFIG.activityId === "missingnotes" || CONFIG.activityId === "tonic" || CONFIG.activityId === "transposing" || (CONFIG.activityId === "keysig" && question.build) || (CONFIG.activityId === "chords" && level === "AH");
