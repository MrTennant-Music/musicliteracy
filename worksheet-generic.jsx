...
(() => {
  ...
  function PracticeWorksheetApp() {
    ...
    const [name,setName]=useGenericState(editorState?.name??true), [classField,setClassField]=useGenericState(editorState?.classField??false), [date,setDate]=useGenericState(editorState?.date??false), [answersOn,setAnswersOn]=useGenericState(editorState?.answers??false), [preparingMode,setPreparingMode]=useGenericState(null);
