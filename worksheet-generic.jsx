...
(() => {
  ...
  function PracticePaperPage({ paper, data, paperIndex, answers=false, content="combined", pageNumber, totalPages }) {
    ...
    const showPupilFields=!answers&&(level!=="AH"||pageNumber===1);
  ...
  function PracticeWorksheetApp() {
    ...
    const [name,setName]=useGenericState(editorState?.name??true), [classField,setClassField]=useGenericState(editorState?.classField??false), [date,setDate]=useGenericState(editorState?.date??false), [answersOn,setAnswersOn]=useGenericState(editorState?.answers??false), [downloading,setDownloading]=useGenericState(false);
  ...
  function GenericApp() {
    ...
    const [name,setName]=useGenericState(editorState?.name??true), [classField,setClassField]=useGenericState(editorState?.classField??false), [date,setDate]=useGenericState(editorState?.date??false), [numbers,setNumbers]=useGenericState(editorState?.numbers??true), [marks,setMarks]=useGenericState(editorState?.marks??true), [gridlines,setGridlines]=useGenericState(editorState?.gridlines??false), [exampleOn,setExampleOn]=useGenericState(editorState?.example??true), [answersOn,setAnswersOn]=useGenericState(editorState?.answers??false), [downloading,setDownloading]=useGenericState(false);
    const [previewVisible,setPreviewVisible]=useGenericState(true), refreshTimer=useGenericRef(null);
